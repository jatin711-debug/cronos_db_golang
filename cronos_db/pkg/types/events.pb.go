...
const file_proto_events_proto_rawDesc = "" +
	...
	"\flast_applied\x18\x06 \x01(\x03R\vlastApplied2\x8b\x02\n" +
	"\fEventService\x12@\n" +
	"\aPublish\x12\x19.cronos_db.PublishRequest\x1a\x1a.cronos_db.PublishResponse\x12A\n" +
...
var file_proto_events_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_proto_events_proto_goTypes = []any{
	...
	(*SubscribeRequest)(nil),               // 3: cronos_db.SubscribeRequest
	(*Delivery)(nil),                       // 4: cronos_db.Delivery
	(*AckRequest)(nil),                     // 5: cronos_db.AckRequest
	(*AckResponse)(nil),                    // 6: cronos_db.AckResponse
	(*ReplayRequest)(nil),                  // 7: cronos_db.ReplayRequest
	(*ReplayEvent)(nil),                    // 8: cronos_db.ReplayEvent
	(*ConsumerGroupMetadata)(nil),          // 9: cronos_db.ConsumerGroupMetadata
	(*CreateConsumerGroupRequest)(nil),     // 10: cronos_db.CreateConsumerGroupRequest
	(*CreateConsumerGroupResponse)(nil),    // 11: cronos_db.CreateConsumerGroupResponse
	(*GetConsumerGroupRequest)(nil),        // 12: cronos_db.GetConsumerGroupRequest
	(*ListConsumerGroupsRequest)(nil),      // 13: cronos_db.ListConsumerGroupsRequest
	(*ListConsumerGroupsResponse)(nil),     // 14: cronos_db.ListConsumerGroupsResponse
	(*RebalanceConsumerGroupRequest)(nil),  // 15: cronos_db.RebalanceConsumerGroupRequest
	(*RebalanceConsumerGroupResponse)(nil), // 16: cronos_db.RebalanceConsumerGroupResponse
	(*ReplicationAppendRequest)(nil),       // 17: cronos_db.ReplicationAppendRequest
	(*ReplicationAppendResponse)(nil),      // 18: cronos_db.ReplicationAppendResponse
	(*ReplicationSyncRequest)(nil),         // 19: cronos_db.ReplicationSyncRequest
	(*ReplicationSyncResponse)(nil),        // 20: cronos_db.ReplicationSyncResponse
	(*PartitionInfo)(nil),                  // 21: cronos_db.PartitionInfo
	(*GetPartitionRequest)(nil),            // 22: cronos_db.GetPartitionRequest
	(*ListPartitionsRequest)(nil),          // 23: cronos_db.ListPartitionsRequest
	(*ListPartitionsResponse)(nil),         // 24: cronos_db.ListPartitionsResponse
	(*GetWALStatusRequest)(nil),            // 25: cronos_db.GetWALStatusRequest
	(*WALStatus)(nil),                      // 26: cronos_db.WALStatus
	(*GetSchedulerStatusRequest)(nil),      // 27: cronos_db.GetSchedulerStatusRequest
	(*SchedulerStatus)(nil),                // 28: cronos_db.SchedulerStatus
	(*CompactRequest)(nil),                 // 29: cronos_db.CompactRequest
	(*CompactResponse)(nil),                // 30: cronos_db.CompactResponse
	(*RetentionRequest)(nil),               // 31: cronos_db.RetentionRequest
	(*RetentionResponse)(nil),              // 32: cronos_db.RetentionResponse
	(*RaftJoinRequest)(nil),                // 33: cronos_db.RaftJoinRequest
	(*RaftJoinResponse)(nil),               // 34: cronos_db.RaftJoinResponse
	(*RaftLeaveRequest)(nil),               // 35: cronos_db.RaftLeaveRequest
	(*RaftLeaveResponse)(nil),              // 36: cronos_db.RaftLeaveResponse
	(*RaftStatusRequest)(nil),              // 37: cronos_db.RaftStatusRequest
	(*RaftStatusResponse)(nil),             // 38: cronos_db.RaftStatusResponse
	nil,                                    // 39: cronos_db.Event.MetaEntry
	nil,                                    // 40: cronos_db.ConsumerGroupMetadata.CommittedOffsetsEntry
	nil,                                    // 41: cronos_db.ConsumerGroupMetadata.MemberOffsetsEntry
	nil,                                    // 42: cronos_db.RebalanceConsumerGroupResponse.PartitionAssignmentsEntry
}
var file_proto_events_proto_depIdxs = []int32{
	39, // 0: cronos_db.Event.meta:type_name -> cronos_db.Event.MetaEntry
	0,  // 1: cronos_db.PublishRequest.event:type_name -> cronos_db.Event
	0,  // 2: cronos_db.Delivery.event:type_name -> cronos_db.Event
	0,  // 3: cronos_db.Delivery.batch:type_name -> cronos_db.Event
	0,  // 4: cronos_db.ReplayEvent.event:type_name -> cronos_db.Event
	40, // 5: cronos_db.ConsumerGroupMetadata.committed_offsets:type_name -> cronos_db.ConsumerGroupMetadata.CommittedOffsetsEntry
	41, // 6: cronos_db.ConsumerGroupMetadata.member_offsets:type_name -> cronos_db.ConsumerGroupMetadata.MemberOffsetsEntry
	9,  // 7: cronos_db.ListConsumerGroupsResponse.groups:type_name -> cronos_db.ConsumerGroupMetadata
	42, // 8: cronos_db.RebalanceConsumerGroupResponse.partition_assignments:type_name -> cronos_db.RebalanceConsumerGroupResponse.PartitionAssignmentsEntry
	0,  // 9: cronos_db.ReplicationAppendRequest.events:type_name -> cronos_db.Event
	0,  // 10: cronos_db.ReplicationSyncResponse.events:type_name -> cronos_db.Event
	21, // 11: cronos_db.ListPartitionsResponse.partitions:type_name -> cronos_db.PartitionInfo
	1,  // 12: cronos_db.EventService.Publish:input_type -> cronos_db.PublishRequest
	3,  // 13: cronos_db.EventService.Subscribe:input_type -> cronos_db.SubscribeRequest
	5,  // 14: cronos_db.EventService.Ack:input_type -> cronos_db.AckRequest
	7,  // 15: cronos_db.EventService.Replay:input_type -> cronos_db.ReplayRequest
	22, // 16: cronos_db.PartitionService.GetPartition:input_type -> cronos_db.GetPartitionRequest
	23, // 17: cronos_db.PartitionService.ListPartitions:input_type -> cronos_db.ListPartitionsRequest
	25, // 18: cronos_db.PartitionService.GetWALStatus:input_type -> cronos_db.GetWALStatusRequest
	27, // 19: cronos_db.PartitionService.GetSchedulerStatus:input_type -> cronos_db.GetSchedulerStatusRequest
	29, // 20: cronos_db.PartitionService.Compact:input_type -> cronos_db.CompactRequest
	31, // 21: cronos_db.PartitionService.RunRetention:input_type -> cronos_db.RetentionRequest
	10, // 22: cronos_db.ConsumerGroupService.CreateConsumerGroup:input_type -> cronos_db.CreateConsumerGroupRequest
	12, // 23: cronos_db.ConsumerGroupService.GetConsumerGroup:input_type -> cronos_db.GetConsumerGroupRequest
	13, // 24: cronos_db.ConsumerGroupService.ListConsumerGroups:input_type -> cronos_db.ListConsumerGroupsRequest
	15, // 25: cronos_db.ConsumerGroupService.RebalanceConsumerGroup:input_type -> cronos_db.RebalanceConsumerGroupRequest
	17, // 26: cronos_db.ReplicationService.Append:input_type -> cronos_db.ReplicationAppendRequest
	19, // 27: cronos_db.ReplicationService.Sync:input_type -> cronos_db.ReplicationSyncRequest
	33, // 28: cronos_db.RaftService.Join:input_type -> cronos_db.RaftJoinRequest
	35, // 29: cronos_db.RaftService.Leave:input_type -> cronos_db.RaftLeaveRequest
	37, // 30: cronos_db.RaftService.Status:input_type -> cronos_db.RaftStatusRequest
	2,  // 31: cronos_db.EventService.Publish:output_type -> cronos_db.PublishResponse
	4,  // 32: cronos_db.EventService.Subscribe:output_type -> cronos_db.Delivery
	6,  // 33: cronos_db.EventService.Ack:output_type -> cronos_db.AckResponse
	8,  // 34: cronos_db.EventService.Replay:output_type -> cronos_db.ReplayEvent
	21, // 35: cronos_db.PartitionService.GetPartition:output_type -> cronos_db.PartitionInfo
	24, // 36: cronos_db.PartitionService.ListPartitions:output_type -> cronos_db.ListPartitionsResponse
	26, // 37: cronos_db.PartitionService.GetWALStatus:output_type -> cronos_db.WALStatus
	28, // 38: cronos_db.PartitionService.GetSchedulerStatus:output_type -> cronos_db.SchedulerStatus
	30, // 39: cronos_db.PartitionService.Compact:output_type -> cronos_db.CompactResponse
	32, // 40: cronos_db.PartitionService.RunRetention:output_type -> cronos_db.RetentionResponse
	11, // 41: cronos_db.ConsumerGroupService.CreateConsumerGroup:output_type -> cronos_db.CreateConsumerGroupResponse
	9,  // 42: cronos_db.ConsumerGroupService.GetConsumerGroup:output_type -> cronos_db.ConsumerGroupMetadata
	14, // 43: cronos_db.ConsumerGroupService.ListConsumerGroups:output_type -> cronos_db.ListConsumerGroupsResponse
	16, // 44: cronos_db.ConsumerGroupService.RebalanceConsumerGroup:output_type -> cronos_db.RebalanceConsumerGroupResponse
	18, // 45: cronos_db.ReplicationService.Append:output_type -> cronos_db.ReplicationAppendResponse
	20, // 46: cronos_db.ReplicationService.Sync:output_type -> cronos_db.ReplicationSyncResponse
	34, // 47: cronos_db.RaftService.Join:output_type -> cronos_db.RaftJoinResponse
	36, // 48: cronos_db.RaftService.Leave:output_type -> cronos_db.RaftLeaveResponse
	38, // 49: cronos_db.RaftService.Status:output_type -> cronos_db.RaftStatusResponse
